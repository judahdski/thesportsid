        ...
        <section class="news-page-container">
            ...
            <div class="container">
                <div class="row justify-content-center d-flex flex-column flex-md-row">
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="/blogs/{{ $blogs[0]->slug }}" class="text-reset text-decoration-none">
                                    <div class="card mb-3">
                                        <img src="https://source.unsplash.com/1200x600?{{ $blogs[0]->category->name }}"
                                            class="card-img-top" alt="{{ $blogs[0]->category->name }}">
                                        <div class="card-body">
                                            <h5 class="card-title">{{ $blogs[0]->title }}</h5>
                                            <p class="card-text">{{ $blogs[0]->category->name }} • {{ $blogs[0]->read_time }} menit</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                <a href="/blogs/{{ $b->slug }}" class="text-reset text-decoration-none">
                                    <div class="card">
                                        <img src="https://source.unsplash.com/600x350?{{ $b->category->name }}"
                                            class="card-img-top" alt="{{ $b->category->name }}">
                                        <div class="card-body">
                                            <h5 class="card-title">{{ $b->title }}</h5>
                                            @if ($b->excerpt == null)
                                                <p class="card-text">{{ $b->category->name }} • {{ $b->read_time }} menit</p>
                                            @else
                    ...
                    @else
                    <div class="col-md-7 me-md-4">
                        <p>Tidak ada blog yang ada di dalam sistem.</p>
                    </div>
                    @endif
                            ...
                            <div class="row d-flex flex-column">
                                ...
                                <div class="col px-3 my-4">
                                    <a href="/news/{{ $n->slug }}" class="text-reset text-decoration-none">
                                        <h4>{{ $n->title }}</h4>
                                        <small class="text-muted">{{ $n->category->name }} • Last updated {{ $n->created_at->diffForHumans() }}</small></small>
                                    </a>
                                </div>  
                                @endforeach
                                <div class="mt-5 d-flex justify-content-center">
